...
Total Actual Gross across all tours

Average Actual Gross per tour

Maximum Actual Gross among all tours
...
Bar Chart: Sum of Actual Gross by Tour Name

Sorted from highest to lowest

Clear axis labels and formatted numbers (e.g., 0.5bn)
...
Readable typography for KPI cards and charts
...
How Actual Gross varies by country

Which tours had the largest attendance
